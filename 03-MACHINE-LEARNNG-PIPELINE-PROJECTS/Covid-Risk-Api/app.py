...
app = FastAPI(
    title="COVID-19 Risk Assessment API",
    description="ML-powered COVID-19 risk prediction API",
    version="1.0.0"
)
...
def calculate_risk(patient: PatientData):
    ...
    if risk_score >= 70:
        risk = "High"
        confidence = 0.85
        recommendation = "Seek medical attention immediately. Isolate and get tested."
    elif risk_score >= 40:
        risk = "Medium"
        confidence = 0.70
...
def root():
    return {
        "service": "COVID-19 Risk Assessment API",
        "status": "operational",
        "version": "1.0.0",
